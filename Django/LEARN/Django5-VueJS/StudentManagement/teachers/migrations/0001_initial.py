    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(help_text='格式如：2024-05-01', verbose_name='出生日期')),
                ('contact_number', models.CharField(max_length=20, verbose_name='联系方式')),
                ('address', models.CharField(max_length=50, verbose_name='家庭住址')),
                ('grade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teachers', to='grades.grade', verbose_name='班级')),
